...
export default function ProfilePage() {
  ...
  const pageTitle = () => {
    ...
    if (user.role === 'employer' && user.isCompanyAdmin) return "Manage Company Profile & Your Recruiter Info";
  ...
  const pageDescription = () => {
    ...
    if (user.role === 'jobSeeker') return "View and manage your account details and professional information. Upload your resume below.";
    if (user.role === 'employer' && user.isCompanyAdmin) return "Edit your company's public details and your personal recruiter information.";
    if (user.role === 'employer') return "Manage your personal recruiter details.";
    if (user.role === 'admin') return "Manage your administrator profile details.";
